...
void P18C2x2::create_iopin_map()
{
    ...
    set_osc_pin_Number(0, 9, nullptr);
...
void P18C2x2::create_symbols()
{
    if (verbose)
    {
        std::cout << "P18C2x2 create symbols\n";
    }
    ...
    : _16bit_compat_adc(_name, desc)
{
    if (verbose)
    {
        std::cout << "18c2x2 constructor, type = " << isa() << '\n';
    }
}
    ...
    : P18C2x2(_name, desc)
{
    if (verbose)
    {
        std::cout << "18c242 constructor, type = " << isa() << '\n';
    }
}
    ...
    : P18C242(_name, desc)
{
    if (verbose)
    {
        std::cout << "18c252 constructor, type = " << isa() << '\n';
    }
}
...
void P18C4x2::create_symbols()
{
    if (verbose)
    {
        std::cout << "P18C4x2 create symbols\n";
    }
    ...
    : _16bit_compat_adc(_name, desc)
{
    if (verbose)
    {
        std::cout << "18c4x2 constructor, type = " << isa() << '\n';
    }
...
void P18C4x2::create_sfr_map()
{
    if (verbose)
    {
        std::cout << "create_sfr_map P18C4x2\n";
    }
    ...
    : P18C4x2(_name, desc)
{
    if (verbose)
    {
        std::cout << "18c442 constructor, type = " << isa() << '\n';
    }
}
...
void P18C442::create()
{
    if (verbose)
    {
        std::cout << " 18c442 create \n";
    }

    P18C4x2::create();
    std::cout << " 18c442 create \n";
    set_osc_pin_Number(0, 13, nullptr);
    ...
    : P18C442(_name, desc)
{
    if (verbose)
    {
        std::cout << "18c452 constructor, type = " << isa() << '\n';
    }
}
    ...
    : P18C242(_name, desc)
{
    if (verbose)
    {
        std::cout << "18f242 constructor, type = " << isa() << '\n';
    }
}
...

{
    if (verbose)
    {
        std::cout << "18f252 constructor, type = " << isa() << '\n';
    }
}
    ...
    : P18C442(_name, desc)
{
    if (verbose)
    {
        std::cout << "18f442 constructor, type = " << isa() << '\n';
    }
}
    ...
    : P18F242(_name, desc)
{
    if (verbose)
    {
        std::cout << "18f248 constructor, type = " << isa() << '\n';
    }
}
    ...
    : P18F252(_name, desc)
{
    if (verbose)
    {
        std::cout << "18f258 constructor, type = " << isa() << '\n';
    }
}
    ...
    : P18F442(_name, desc)
{
    if (verbose)
    {
        std::cout << "18f448 constructor, type = " << isa() << '\n';
    }
}
    ...
    : P18F442(_name, desc)
{
    if (verbose)
    {
        std::cout << "18f452 constructor, type = " << isa() << '\n';
    }
}
    ...
    : P18F452(_name, desc)
{
    if (verbose)
    {
        std::cout << "18f458 constructor, type = " << isa() << '\n';
    }
}
      ...
      uep15(this, "uep15", "USB Endpoint 15 Enable register")
{
    ...
    if (verbose)
    {
        std::cout << "18f2455 constructor, type = " << isa() << '\n';
    }
}
...
void P18F2455::create_sfr_map()
{
    if (verbose)
    {
        std::cout << " 18f2455 create_sfr_map \n";
    }
      ...
      uep15(this, "uep15", "USB Endpoint 15 Enable register")
{
    ...
    if (verbose)
    {
        std::cout << "18f2550 constructor, type = " << isa() << '\n';
    }
}
...
void P18F2550::create_sfr_map()
{
    if (verbose)
    {
        std::cout << " 18f2550 create_sfr_map \n";
    }
...

{
    ...
    if (verbose)
    {
        std::cout << "18f4455 constructor, type = " << isa() << '\n';
    }
}
...
{
    P18F4x21::create(true);

    if (verbose)
    {
        std::cout << " 18f4455 create \n";
    }
...

{
    ...
    if (verbose)
    {
        std::cout << "18f4550 constructor, type = " << isa() << '\n';
    }
}
...
void P18F1220::create_base_ports()
{
...

{
    if (verbose)
    {
        std::cout << "18F1220 constructor, type = " << isa() << '\n';
    }
}
    ...
    : P18F1220(_name, desc)
{
    if (verbose)
    {
        std::cout << "18f1320 constructor, type = " << isa() << '\n';
    }
}
...
void P18F2x21::create(bool has_usb)
{
    if (verbose)
    {
        std::cout << "P18F2x21::create\n";
    }
...
//------------------------------------------------------------------------
void P18F2x21::create_iopin_map(bool has_usb)
{
    package = new Package(28);
...
void P18F2x21::create_symbols()
{
    if (verbose)
    {
        std::cout << "P18F2x21 create symbols\n";
    }
...
P18F2x21::P18F2x21(const char *_name, const char *desc)
    : _16bit_v2_adc(_name, desc), m_trise(nullptr), m_late(nullptr),
      ...
      comparator(this)
{
    if (verbose)
    {
        std::cout << "18F2x21 constructor, type = " << isa() << '\n';
    }
...
void P18F2x21::create_sfr_map()
{
    if (verbose)
    {
        std::cout << "create_sfr_map P18F2x21\n";
    }
    ...
    */
    ...
    //ccp2con.setADCON(adcon0);     // Not yet supported for this type of ADC
    //1 usart16.initialize_16(this,&pir_set_def,&portc);
    ...
    : P18F2x21(_name, desc)
{
    if (verbose)
    {
        std::cout << "18F2221 constructor, type = " << isa() << '\n';
    }
}
...
Processor * P18F2221::construct(const char *name)
{
    ...
    if (verbose & 2)
    {
        std::cout << " 18F2221 construct completed\n";
    }
    ...
    : P18F2x21(_name, desc)
{
    if (verbose)
    {
        std::cout << "18F2321 constructor, type = " << isa() << '\n';
    }
}
...
Processor * P18F2321::construct(const char *name)
{
    ...
    if (verbose & 2)
    {
        std::cout << " 18F2321 construct completed\n";
    }
    ...
    : P18F2x21(_name, desc)
{
    if (verbose)
    {
        std::cout << "18F2420 constructor, type = " << isa() << '\n';
    }
}
...
Processor * P18F2420::construct(const char *name)
{
    ...
    if (verbose & 2)
    {
        std::cout << " 18F2420 construct completed\n";
    }
    ...
    : P18F2x21(_name, desc)
{
    if (verbose)
    {
        std::cout << "18F2520 constructor, type = " << isa() << '\n';
    }
}
...
Processor * P18F2520::construct(const char *name)
{
    ...
    if (verbose & 2)
    {
        std::cout << " 18F2520 construct completed\n";
    }
    ...
    : P18F2x21(_name, desc)
{
    if (verbose)
    {
        std::cout << "18F2525 constructor, type = " << isa() << '\n';
    }
}
...
Processor * P18F2525::construct(const char *name)
{
    ...
    if (verbose & 2)
    {
        std::cout << " 18F2525 construct completed\n";
    }
    ...
    : P18F2x21(_name, desc)
{
    if (verbose)
    {
        std::cout << "18F2620 constructor, type = " << isa() << '\n';
    }
}
...
Processor * P18F2620::construct(const char *name)
{
    ...
    if (verbose & 2)
    {
        std::cout << " 18F2620 construct completed\n";
    }
...
void P18F4x21::create(bool has_usb)
{
    if (verbose)
    {
        std::cout << "P18F4x21::create\n";
    }
    ...
    set_eeprom_pir(&tbl);
    tbl.set_pir(pir2);
    tbl.eecon1.set_valid_bits(0xdf);
    _16bit_processor::create();
    create_iopin_map(has_usb);
    create_sfr_map();
...
//------------------------------------------------------------------------
void P18F4x21::create_iopin_map(bool has_usb)
{
    package = new Package(40);
...
void P18F4x21::create_symbols()
{
    if (verbose)
    {
        std::cout << "P18F4x21 create symbols\n";
    }
    ...
    : P18F2x21(_name, desc)
{
    if (verbose)
    {
        std::cout << "18f4x21 constructor, type = " << isa() << '\n';
    }
...
void P18F4x21::create_sfr_map()
{
    if (verbose)
    {
        std::cout << "create_sfr_map P18F4x21\n";
    }
    ...
    : P18F4x21(_name, desc)
{
    if (verbose)
    {
        std::cout << "18F4221 constructor, type = " << isa() << '\n';
    }
}
...
Processor * P18F4221::construct(const char *name)
{
    ...
    if (verbose & 2)
    {
        std::cout << " 18F4221 construct completed\n";
    }
    ...
    : P18F4x21(_name, desc)
{
    if (verbose)
    {
        std::cout << "18F4321 constructor, type = " << isa() << '\n';
    }
}
...
Processor * P18F4321::construct(const char *name)
{
    ...
    if (verbose & 2)
    {
        std::cout << " 18F4321 construct completed\n";
    }
    ...
    : P18F4x21(_name, desc)
{
    if (verbose)
    {
        std::cout << "18F4420 constructor, type = " << isa() << '\n';
    }
}
...
Processor * P18F4420::construct(const char *name)
{
    ...
    if (verbose & 2)
    {
        std::cout << " 18F4420 construct completed\n";
    }
    ...
    : P18F4x21(_name, desc)
{
    if (verbose)
    {
        std::cout << "18F4520 constructor, type = " << isa() << '\n';
    }
}
...
Processor * P18F4520::construct(const char *name)
{
    ...
    if (verbose & 2)
    {
        std::cout << " 18F4520 construct completed\n";
    }
    ...
    : P18F4x21(_name, desc)
{
    if (verbose)
    {
        std::cout << "18F4620 constructor, type = " << isa() << '\n';
    }
}
...
Processor * P18F4620::construct(const char *name)
{
    ...
    if (verbose & 2)
    {
        std::cout << " 18F4620 construct completed\n";
    }
...
void P18F6x20::create_iopin_map()
{
    ...
    set_osc_pin_Number(0, 39, nullptr);
...
void P18F6x20::create_symbols()
{
    if (verbose)
    {
        std::cout << "P18F6x20 create symbols\n";
    }
      ...
      usart2(this), comparator(this)
{
    if (verbose)
    {
        std::cout << "18F6x20 constructor, type = " << isa() << '\n';
    }
...
void P18F6x20::create_sfr_map()
{
    if (verbose)
    {
        std::cout << "create_sfr_map P18F6x20\n";
    }
    ...
    : P18F6x20(_name, desc)
{
    if (verbose)
    {
        std::cout << "18F6520 constructor, type = " << isa() << '\n';
    }
}
...
Processor * P18F6520::construct(const char *name)
{
    ...
    if (verbose & 2)
    {
        std::cout << " 18F6520 construct completed\n";
    }
