...
class P18F25K20 : public _16bit_processor
{
public:
    P18F25K20(const char *_name = nullptr, const char *desc = nullptr);
    ~P18F25K20();
    ...
    PROCESSOR_TYPE isa() override { return _P18F25K20_; }
    PROCESSOR_TYPE base_isa() override { return _PIC18_PROCESSOR_; }
    unsigned int access_gprs() override { return 0x60; }
    ...
    unsigned int eeprom_memory_size() const { return 256; }
    unsigned int get_device_id() override { return (0x20 << 8) | (0x3 << 5); }
    ...
    void set_eeprom_pir(EEPROM_PIR *ep) { eeprom = ep; }
    EEPROM_PIR *get_eeprom() override { return (EEPROM_PIR *)eeprom; }
};
