...
;
   ...
   .sim "p18f6520.xpos = 84"
   .sim "p18f6520.ypos = 96"
...
start
  ...
  .assert "trisa==0x7f, \"*** FAILED 18f6520 reset bad TRISA\""
	nop
  .assert "trisb==0xff, \"*** FAILED 18f6520 reset bad TRISB\""
	nop
  .assert "trisc==0xff, \"*** FAILED 18f6520 reset bad TRISC\""
	nop
  .assert "trisd==0xff, \"*** FAILED 18f6520 reset bad TRISD\""
	nop
  .assert "trise==0xff, \"*** FAILED 18f6520 reset bad TRISE\""
	nop
  .assert "trisf==0xff, \"*** FAILED 18f6520 reset bad TRISF\""
	nop
  .assert "trisg==0x1f, \"*** FAILED 18f6520 reset bad TRISG\""
	nop
...
PowerOnReset:
  ...
  .command "resetCounter = resetCounter+1"
   ...
   ; RRR WDT will not cause a reset but will fall through
        ...
        nop
  .assert "(trisa&0x1f)==0x00, \"*** FAILED 18f6520 WDT sleep bad TRISA\""
	nop
  .assert "trisb==0x11, \"*** FAILED 18f6520 WDT sleep bad TRISB\""
	nop
  .assert "trisc==0x00, \"*** FAILED 18f6520 WDT sleep bad TRISC\""
	nop
  .assert "trisd==0x00, \"*** FAILED 18f6520 WDT sleep bad TRISD\""
	nop
  .assert "(trise&0x03)==0x00, \"*** FAILED 18f6520 WDT sleep bad TRISE\""
	nop
...
WDTTimeOut:
  ...
  .command "resetCounter = resetCounter+1"
  .assert "(tmr0l - W) == 0, \"*** FAILED 18f6520 reset - TMR0 stops during sleep\""
        nop
...
waitForMCLR:    goto waitForMCLR
  ...
  .assert  "\"*** PASSED 18f6520 Sleep and Reset test\""
