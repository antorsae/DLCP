...
start	
   ...
   .sim "node n1"
   .sim "attach n1 portc4 pu1.pin portb4 i2c.SDA" ; SDA
   .sim "node n2"
   .sim "attach n2 portc3 pu2.pin portb1 i2c.SCL" ; SCL
   .sim "node n3"
   .sim "node n4"
   .sim "node n5"
   .sim "node n6"
...
write_i2c2par_address
	...
	btfsc	SSPCON2,SEN
	goto	$-1	
	movlw	(I2C_ADD<<1)|1		; write command to i2c2par
	call	I2C_send_w
  ...
  .assert "\"DEBUG\""
	...
	banksel PIR1
	bcf	PIR1,SSPIF
	movlw	0x00		; write i2c2par address
	call	I2C_send_w
  .assert "(sspcon2 & 0x40) == 0x00, \"FAILED write address to i2c2par ACK\""
	nop
	return

write_eeprom
	call 	write_i2c2par_address
	banksel PIR1
	bcf	PIR1,SSPIF
