	; 16f628 gpsim regression test
	;
	; The purpose of this test is to verify that the 'F628
...
RESET_VECTOR  CODE    0x000              ; processor reset vector
  .assert "option_reg==0xff,\"*** FAILED 16f628 reset bad OPTION_REG\""
  .assert "(trisa&0x1f)==0x1f, \"*** FAILED 16f628 reset bad TRISA\""
  .assert "(trisb&0xff)==0xff, \"*** FAILED 16f628 reset bad TRISB\""
...
WDTTimeOut:
  ...
  .command "resetCounter = resetCounter+1"
  .assert "(tmr0 - W) < 2, \"*** FAILED 16f628 reset - TMR0 stops during sleep\""
        nop
...
waitForMCLR:    goto waitForMCLR
  ...
  .assert  "\"*** PASSED 16f628 Sleep and Reset test\""
