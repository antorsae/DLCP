...
- `test_v17x_isr_scratch_collision.py` (stock-latent 0x00C/0x00D ISR/foreground scratch collision: baseline RC5-decode pin plus two strict-xfail contracts -- IR frame dropped when the foreground is mid-delay, and ISR residue inflating the interrupted delay count; fix tracked as task #7)
