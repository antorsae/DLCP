...
- MAIN `V35_MAIN_HEX`: V3.5 EEPROM rev `0x009A`, SHA-256 `7d84601e588df6840c9f1d5d849cc7b74eaa9d0b07ec7c9f9c2c8487adfeb157`.
- CONTROL `V173_CONTROL_HEX`: V1.73 rev `0x62`, build `20260630`, SHA-256 `5b1c5bf41ade024a6fdad1df8715a7952e9be630d64be7445a71b0c45e684b4a`.
...
| `test_v35_chain_copy_tos_rewrite_masks_and_restores_prior_gie` | V3.5 `chain_copy` descriptor-skip TOS rewrite interrupt window | `V35_MAIN_ASM`; fixed at V3.5 rev `0x0095` and carried by current canonical rev `0x009A` | Helper must preserve prior `GIE`, clear `GIE` for the `TOSL/TOSH` commit, restore only if previously set, and leave `BSR=0` | Previous source failed the structural proof and remained strict-xfailed | Focused chain-copy/release identity gate passed; `main-v35` RAM safety OK | Full simulator gate: `2150 passed, 2 skipped, 2 xfailed, 7 warnings in 991.13s` | Not run; structural PIC18 contract |
