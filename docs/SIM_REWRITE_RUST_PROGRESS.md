...
- [blocked] P3.6b CONTROL BF/2N diag reply processing parity — **research closed 2026-04-28 (test-scenario artifact framing); RE-OPENED 2026-05-04 as rust fidelity bug after user pushback (real HW shows diag values after 4 RIGHT presses without further input; rust chain goes silent post-nav per probes v15-v18 — likely Timer3/Timer1 ISR vector dispatch failing on rust). See task #94.**
