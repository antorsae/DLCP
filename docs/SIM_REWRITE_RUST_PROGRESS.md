...
- [in_progress] P4.4 Migrate `test_v17_*` tests (single-MAIN baseline)
  ...
  - sub-task [pending] `test_v17_rebuilt_chain_reaches_display` (V1.7 byte-identical rebuild)
  - sub-task [pending] `test_v17_shifted_chain_reaches_display` (V1.7 +0x222 relocated)
  - sub-task [pending] `test_v17_stock_v16b_blackout_wake_shows_waiting` (needs `set_blackout` + `press("STBY")` rust bindings)
  - sub-task [pending] `test_v17_rebuilt_blackout_wake_shows_waiting`
  - sub-task [pending] `test_v17_shifted_blackout_wake_shows_waiting`
  - sub-task [pending] migrate `test_v17_shifted_full_parity.py` (18 scenarios)
