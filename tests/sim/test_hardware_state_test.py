...
def test_lcd_raw_ordered_rows_do_not_snap_preset_filename_to_active() -> None:
    observations = [
...
def test_lcd_reconstruct_scroll_windows_stitches_ordered_filename_views() -> None:
...
def test_lcd_probe_raw_ordered_row_summary_includes_scroll_reconstruction(
    monkeypatch,
    tmp_path,
) -> None:
