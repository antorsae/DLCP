...
;              baseline; V1.72 edits land in-place in this file via
...
;              to stock V1.6b. EEPROM matches stock except the V1.72 identity
...
; --- V1.72 boot splash release strings ---
...
; EEDATA area
        ...
        db      0xff
        db      0xff
        ; V1.72 identity bytes at EEPROM 0x70..0x73.
