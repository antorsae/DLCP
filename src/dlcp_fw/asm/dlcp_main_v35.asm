...
restore_eeprom_settings_on_boot__read_preset_a_filename:
    ...
    movlw       0x82
    movwf       count_flash_page_or_i2c_payload_scratch_byte, ACCESS
    movlw       0x91                            ; V3.5_RUNTIME_EEPROM_REV_LO
    movwf       flash_src_low_or_rx_length_scratch_byte, ACCESS
...
; ---------------------------------------------------------------------------
; BUG-PB2-CH6: the table-driven lookup below computes TBLPTRL as
; LOW(table)+2*counter without carrying into TBLPTRH.  Keep both packed
; tables inside one 256-byte page; when the source table crossed 0x1DFF,
; stage 6 read the wrong source pointer and corrupted the TAS 0x28 channel-6
; route payload.
...
cmd25_identity_query_handler:
    ...
    movwf       count_flash_page_or_i2c_payload_scratch_byte, ACCESS
    movlw       0x01                        ; V3.5_IDENTITY_REV_LO_LO
    movwf       flash_end_high_or_loop_mask_scratch_byte, ACCESS
...
eeprom_data:
    ...
    db  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF  ; ................
    db  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF  ; ................
    db  0x03, 0x05, 0x91, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF  ; V3.5 lineage: V3.2 diagnostics plus cmd 0x25 MAIN identity reply; third byte is the legacy low byte of the 16-bit release revision
    db  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF  ; ................
    db  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF  ; ................
    db  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF  ; ................
    db  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF  ; ................
