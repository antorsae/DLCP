...
i2c_tas3108_reg1f_write:
    ...
    bc          i2c_tas3108_reg1f_write__return_success
    movlw       0x68
    rcall       i2c_byte_tx
    movlw       0x1F
    rcall       i2c_byte_tx
...
i2c_secondary_dev_write:
    ...
    bsf         SSPCON2, 0, ACCESS          ; SEN = START
    rcall       wait_sen_bounded
    bc          i2c_secondary_dev_write__return_success
    movlw       0xE2
    call        i2c_byte_tx, 0x0
    movf        ram_0x007, W, ACCESS
    call        i2c_byte_tx, 0x0
...
preset_select_delayed:
    ...
    rcall       preset_replay_selected_table_blocking ; apply new preset while muted
    bcf         active_flags, 4, ACCESS
    bcf         active_flags, 5, ACCESS
...
preset_select_switch_only:
    ...
    movlb       0x0
    bsf         event_flags, 0, BANKED      ; cmd03 dirty
    rcall       preset_replay_selected_table_blocking
