...
; Address : 0x44E4
; Notes   : Inferred i2c helper; touches i2c. Calls: i2c_wait_bus_idle, i2c_byte_tx, main_i2c_service_39a6.
; ---------------------------------------------------------------------------
...
; Address : 0x48B6
; Notes   : Inferred i2c helper; touches i2c. Calls: main_i2c_service_355c, main_usb_service_2f4e, periodic_service_loop.
; ---------------------------------------------------------------------------
i2c_wait_bus_idle:
