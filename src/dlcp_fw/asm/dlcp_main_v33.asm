...
;
; Build      : gpasm -p18f2455 -o DLCP_Firmware_V3.3.hex dlcp_main_v32.asm
...
hid_command_dispatch__apply_settings_payload:
    movff       usb_hid_out_arg0_phys, input_select_b0_phys
    movff       usb_hid_out_arg4_phys, computed_volume_3_b0_phys
    movff       usb_hid_out_arg5_phys, computed_volume_2_b0_phys
    movff       usb_hid_out_arg6_phys, computed_volume_1_b0_phys
    movff       usb_hid_out_arg7_phys, computed_volume_b0_phys
    movlb       0x1
    btfsc       usb_hid_out_arg8_b1, 0, BANKED
...
flow_hid_command_dispatch_11ee:
    movlb       0x1
    btfsc       usb_hid_out_arg9_b1, 0, BANKED
    bra         flow_hid_command_dispatch_11fa
    movlb       0x0
    bcf         channel_enable_mask_b0, 0, BANKED
...
flow_hid_command_dispatch_11fe:
    movlb       0x1
    btfsc       usb_hid_out_arg10_b1, 0, BANKED
    bra         flow_hid_command_dispatch_120a
    movlb       0x0
    bcf         channel_enable_mask_b0, 1, BANKED
...
flow_hid_command_dispatch_120e:
    movlb       0x1
    btfsc       usb_hid_out_arg11_b1, 0, BANKED
    bra         flow_hid_command_dispatch_121a
    movlb       0x0
    bcf         channel_enable_mask_b0, 2, BANKED
...
flow_hid_command_dispatch_121e:
    movlb       0x1
    btfsc       usb_hid_out_arg13_b1, 0, BANKED
    bra         flow_hid_command_dispatch_122a
    movlb       0x0
    bcf         channel_enable_mask_b0, 3, BANKED
...
flow_hid_command_dispatch_122e:
    movlb       0x1
    btfsc       usb_hid_out_arg14_b1, 0, BANKED
    bra         flow_hid_command_dispatch_123a
    movlb       0x0
    bcf         channel_enable_mask_b0, 4, BANKED
...
flow_hid_command_dispatch_123e:
    movlb       0x1
    btfsc       usb_hid_out_arg15_b1, 0, BANKED
    bra         flow_hid_command_dispatch_124a
    movlb       0x0
    bcf         channel_enable_mask_b0, 5, BANKED
...
hid_command_dispatch__compare_settings_mirrors:
    movff       usb_hid_out_arg17_phys, channel_1_source_config_phys
    movff       usb_hid_out_arg18_phys, channel_2_source_config_phys
    movff       usb_hid_out_arg19_phys, channel_3_source_config_phys
    movff       usb_hid_out_arg20_phys, channel_4_source_config_phys
    movff       usb_hid_out_arg21_phys, channel_5_source_config_phys
    movff       usb_hid_out_arg22_phys, channel_6_source_config_phys
    movff       usb_hid_out_arg23_phys, src_route_status_code_b0_phys
    movff       usb_hid_out_arg24_phys, route_0_volume_trim_phys
    movff       usb_hid_out_arg25_phys, route_5_volume_trim_phys
    movff       usb_hid_out_arg26_phys, route_6_volume_trim_phys
    movff       usb_hid_out_arg27_phys, route_7_volume_trim_phys
    movff       usb_hid_out_arg29_phys, setup_profile_setting_phys
...
hid_command_dispatch__check_route_trim_dirty:
    movf        route_0_volume_trim_shadow_b0, W, BANKED
    xorwf       route_0_volume_trim_b0, W, BANKED
    bz          flow_hid_command_dispatch_12ac
    bsf         event_flags_b0, 3, BANKED
    bsf         filename_dirty_flags_b0, 3, BANKED
flow_hid_command_dispatch_12ac:
    movf        route_5_volume_trim_shadow_b0, W, BANKED
    xorwf       route_5_volume_trim_b0, W, BANKED
    bz          flow_hid_command_dispatch_12b6
    bsf         event_flags_b0, 3, BANKED
    bsf         filename_dirty_flags_b0, 3, BANKED
flow_hid_command_dispatch_12b6:
    movf        route_6_volume_trim_shadow_b0, W, BANKED
    xorwf       route_6_volume_trim_b0, W, BANKED
    bz          flow_hid_command_dispatch_12c0
    bsf         event_flags_b0, 3, BANKED
    bsf         filename_dirty_flags_b0, 3, BANKED
flow_hid_command_dispatch_12c0:
    movf        route_7_volume_trim_shadow_b0, W, BANKED
    xorwf       route_7_volume_trim_b0, W, BANKED
...
hid_command_dispatch__check_mute_state_dirty:
    ...
    movlw       0x00
    xorwf       diff_count_update_compare_or_route_mask_scratch_byte, F, ACCESS
...
hid_command_dispatch__check_channel_setup_dirty:
    ...
    movf        channel_1_source_config_b0, W, BANKED
    cpfseq      channel_1_source_config_shadow_b0, BANKED
    bra         hid_command_dispatch__mark_channel_source_dirty
    movf        channel_2_source_config_shadow_b0, W, BANKED
    lfsr        FSR2, channel_2_source_config_phys
    cpfseq      INDF2, ACCESS
    bra         hid_command_dispatch__mark_channel_source_dirty
    movf        channel_3_source_config_shadow_b0, W, BANKED
    lfsr        FSR2, channel_3_source_config_phys
    cpfseq      INDF2, ACCESS
    bra         hid_command_dispatch__mark_channel_source_dirty
    movf        channel_4_source_config_shadow_b0, W, BANKED
    lfsr        FSR2, channel_4_source_config_phys
    cpfseq      INDF2, ACCESS
    bra         hid_command_dispatch__mark_channel_source_dirty
    movf        channel_5_source_config_shadow_b0, W, BANKED
    lfsr        FSR2, channel_5_source_config_phys
    cpfseq      INDF2, ACCESS
    bra         hid_command_dispatch__mark_channel_source_dirty
    movf        channel_6_source_config_b0, W, BANKED
    xorwf       channel_6_source_config_shadow_b0, W, BANKED
    btfss       STATUS, 2, ACCESS
...
hid_command_dispatch__snapshot_settings_mirrors:
    movff       channel_enable_mask_phys, channel_enable_shadow_phys
    movff       channel_1_source_config_phys, channel_1_source_config_shadow_phys
    movff       channel_2_source_config_phys, channel_2_source_config_shadow_phys
    movff       channel_3_source_config_phys, channel_3_source_config_shadow_phys
    movff       channel_4_source_config_phys, channel_4_source_config_shadow_phys
    movff       channel_5_source_config_phys, channel_5_source_config_shadow_phys
    movff       channel_6_source_config_phys, channel_6_source_config_shadow_phys
...
fw_update_relay__emit_active_addr_status_line:
    ...
    movff       TABLAT, fw_update_intel_hex_record_addr_hi_high_nibble_phys
    movff       fw_update_relay_saved_addr_hi_phys, fw_update_hex_byte_or_uart_block_base_low_scratch_phys
    movlw       0x0F
    rcall       nibble_to_hex_ascii
    movff       TABLAT, fw_update_intel_hex_record_addr_hi_low_nibble_phys
    movff       fw_update_relay_saved_addr_lo_phys, fw_update_hex_byte_or_uart_block_base_low_scratch_phys
    rcall       nibble_to_hex_ascii_from_01B
    movff       TABLAT, fw_update_intel_hex_record_addr_lo_high_nibble_phys
    movff       fw_update_relay_saved_addr_lo_phys, fw_update_hex_byte_or_uart_block_base_low_scratch_phys
    movlw       0x0F
    rcall       nibble_to_hex_ascii
    movff       TABLAT, fw_update_intel_hex_record_addr_lo_low_nibble_phys
    movlw       0x30
...
fw_update_relay__forward_payload_byte:
    ...
    rcall       nibble_to_hex_ascii_from_01B
    movff       TABLAT, float32_preset_fw_update_scratch_byte0_b0_phys
    movff       fw_update_even_addr_pending_byte_b0_phys, fw_update_hex_byte_or_uart_block_base_low_scratch_phys
    movlw       0x0F
    rcall       nibble_to_hex_ascii
    movff       TABLAT, preset_payload_index_or_float32_shadow_byte1_b0_phys
    movff       fw_update_relay_current_byte_phys, fw_update_hex_byte_or_uart_block_base_low_scratch_phys
    rcall       nibble_to_hex_ascii_from_01B
    movff       TABLAT, preset_table_row_len_phys
    movff       fw_update_relay_current_byte_phys, fw_update_hex_byte_or_uart_block_base_low_scratch_phys
    movlw       0x0F
    rcall       nibble_to_hex_ascii
    movff       TABLAT, float32_transform_shadow_byte3_b0_phys
...
flow_cmd_dispatch_gated_19be:
    movff       route_0_volume_trim_phys, route_volume_trim_offset_phys
    bra         cmd_dispatch_gated__stage_volume_coefficients
flow_cmd_dispatch_gated_19c4:
    movff       route_5_volume_trim_phys, route_volume_trim_offset_phys
    bra         cmd_dispatch_gated__stage_volume_coefficients
flow_cmd_dispatch_gated_19ca:
    movff       route_6_volume_trim_phys, route_volume_trim_offset_phys
    bra         cmd_dispatch_gated__stage_volume_coefficients
flow_cmd_dispatch_gated_19d0:
    movff       route_7_volume_trim_phys, route_volume_trim_offset_phys
    bra         cmd_dispatch_gated__stage_volume_coefficients
...
cmd_dispatch_gated__stage_volume_coefficients:
    ...
    movff       fw_update_byte_or_flash_addr_mid_or_float_operand_base_phys, volume_dsp_coeff_input_shadow_byte0_phys
    movff       eeprom_record_count_or_flash_addr_upper_or_preset_addr_low_phys, volume_dsp_coeff_input_shadow_byte1_phys
    movff       flash_addr_shadow_low_or_preset_table_addr_hi_phys, volume_dsp_coeff_input_shadow_byte2_phys
    movff       float32_operand_or_flash_addr_shadow_mid_or_preset_job_index_phys, volume_dsp_coeff_input_shadow_byte3_phys
    movff       volume_dsp_coeff_input_shadow_byte0_phys, float32_preset_fw_update_scratch_byte0_b0_phys
    movff       volume_dsp_coeff_input_shadow_byte1_phys, preset_payload_index_or_float32_shadow_byte1_b0_phys
    movff       volume_dsp_coeff_input_shadow_byte2_phys, preset_table_row_len_phys
    movff       volume_dsp_coeff_input_shadow_byte3_phys, float32_transform_shadow_byte3_b0_phys
...
cmd_dispatch_gated__check_channel_enable_dirty:
    ...
    movwf       route_base_or_flash_addr_low_scratch_byte, ACCESS
    movlb       0x0
    btfsc       channel_enable_mask_b0, 0, BANKED
...
flow_cmd_dispatch_gated_1ada:
    ...
    btfsc       channel_enable_mask_b0, 1, BANKED
...
flow_cmd_dispatch_gated_1af0:
    rcall       i2c_381c_with_w_bank0           ; W05-E01: factored 3-line pattern
    btfsc       channel_enable_mask_b0, 2, BANKED
...
flow_cmd_dispatch_gated_1b06:
    rcall       i2c_381c_with_w_bank0           ; W05-E01: factored 3-line pattern
    btfsc       channel_enable_mask_b0, 3, BANKED
...
flow_cmd_dispatch_gated_1b1c:
    rcall       i2c_381c_with_w_bank0           ; W05-E01: factored 3-line pattern
    btfsc       channel_enable_mask_b0, 4, BANKED
...
flow_cmd_dispatch_gated_1b32:
    rcall       i2c_381c_with_w_bank0           ; W05-E01: factored 3-line pattern
    btfsc       channel_enable_mask_b0, 5, BANKED
...
parser_route_phase_handler:
    ...
    movf        eeprom_mask_or_flash_src_high_scratch_byte, W, ACCESS                 ; no  -> echo to next link
    call        uart_tx_byte_blocking, 0x0
...
wake_request_handler:
    ...
    movwf       length_mask_or_divisor_low_scratch_byte, ACCESS                    ; ram_0x005 = (gate-was-closed) ? 1 : 0
...
flow_main_uart_service_1be6_1d96:
    movff       current_cmd_data_b0_phys, channel_1_source_config_phys
    movf        channel_1_source_config_shadow_b0, W, BANKED
    xorwf       channel_1_source_config_b0, W, BANKED
    bz          uart_link_parser__handler_return_tail
    bsf         event_flags_b0, 4, BANKED
    movff       channel_1_source_config_phys, channel_1_source_config_shadow_phys
    bra         uart_link_parser__handler_return_tail
flow_main_uart_service_1be6_1da8:
    movff       current_cmd_data_b0_phys, channel_2_source_config_phys
    movf        channel_2_source_config_b0, W, BANKED
    xorwf       channel_2_source_config_shadow_b0, W, BANKED
    btfss       STATUS, 2, ACCESS
    bsf         event_flags_b0, 4, BANKED
    movff       channel_2_source_config_phys, channel_2_source_config_shadow_phys
    bra         uart_link_parser__handler_return_tail
flow_main_uart_service_1be6_1dba:
    movff       current_cmd_data_b0_phys, channel_3_source_config_phys
    movf        channel_3_source_config_b0, W, BANKED
    xorwf       channel_3_source_config_shadow_b0, W, BANKED
    btfss       STATUS, 2, ACCESS
    bsf         event_flags_b0, 4, BANKED
    movff       channel_3_source_config_phys, channel_3_source_config_shadow_phys
    bra         uart_link_parser__handler_return_tail
flow_main_uart_service_1be6_1dcc:
    movff       current_cmd_data_b0_phys, channel_4_source_config_phys
    movf        channel_4_source_config_b0, W, BANKED
    xorwf       channel_4_source_config_shadow_b0, W, BANKED
    btfss       STATUS, 2, ACCESS
    bsf         event_flags_b0, 4, BANKED
    movff       channel_4_source_config_phys, channel_4_source_config_shadow_phys
    bra         uart_link_parser__handler_return_tail
flow_main_uart_service_1be6_1dde:
    movff       current_cmd_data_b0_phys, channel_5_source_config_phys
    movf        channel_5_source_config_b0, W, BANKED
    xorwf       channel_5_source_config_shadow_b0, W, BANKED
    btfss       STATUS, 2, ACCESS
    bsf         event_flags_b0, 4, BANKED
    movff       channel_5_source_config_phys, channel_5_source_config_shadow_phys
    bra         uart_link_parser__handler_return_tail
flow_main_uart_service_1be6_1df0:
    movff       current_cmd_data_b0_phys, channel_6_source_config_phys
    movf        channel_6_source_config_b0, W, BANKED
    xorwf       channel_6_source_config_shadow_b0, W, BANKED
    btfss       STATUS, 2, ACCESS
    bsf         event_flags_b0, 4, BANKED
...
restore_eeprom_settings_on_boot:
    ...
    movlw       0x07
    rcall       eeprom_read_byte_at_w
    movwf       channel_1_source_config_b0, BANKED
    movlw       0x08
    rcall       eeprom_read_byte_at_w
    movwf       channel_2_source_config_b0, BANKED
    movlw       0x09
    rcall       eeprom_read_byte_at_w
    movwf       channel_3_source_config_b0, BANKED
    movlw       0x0A
    rcall       eeprom_read_byte_at_w
...
restore_eeprom_settings_on_boot__read_route_trim_eeprom:
    movlw       0x10
    rcall       eeprom_read_byte_at_w
    movwf       route_0_volume_trim_b0, BANKED
    movlw       0x11
    rcall       eeprom_read_byte_at_w
    movwf       route_5_volume_trim_b0, BANKED
    movlw       0x12
    rcall       eeprom_read_byte_at_w
    movwf       route_6_volume_trim_b0, BANKED
    movlw       0x13
    rcall       eeprom_read_byte_at_w
    movwf       route_7_volume_trim_b0, BANKED
    movlw       0x12
...
stage_hid_ep1_in_report_from_selector__stage_selector5_status_snapshot:
    ...
    btfsc       active_flags_acc, 4, ACCESS
    movlw       0x01
    movwf       usb_hid_ep1_in_report_payload_byte6_b1, BANKED
    movlw       0x00
    movlb       0x0
    btfsc       channel_enable_mask_b0, 0, BANKED
    movlw       0x01
    ...
    movff       channel_1_source_config_phys, usb_hid_ep1_in_report_payload_byte15_phys
    movff       channel_2_source_config_phys, usb_hid_ep1_in_report_payload_byte16_phys
    movff       channel_3_source_config_phys, usb_hid_ep1_in_report_payload_byte17_phys
    movff       channel_4_source_config_phys, usb_hid_ep1_in_report_payload_byte18_phys
    movff       channel_5_source_config_phys, usb_hid_ep1_in_report_payload_byte19_phys
    movff       channel_6_source_config_phys, usb_hid_ep1_in_report_payload_byte20_phys
    movff       setup_profile_setting_phys, usb_hid_ep1_in_report_setup_profile_phys
    bra         stage_hid_ep1_in_report_from_selector__clear_selector_and_return
...
flow_main_core_service_24c2_24d8:
    ...
    movff       float32_math_operand_byte0_b0_phys, float32_secondary_work_byte0_b0_phys
    movff       float32_math_operand_byte1_b0_phys, float32_secondary_work_byte1_b0_phys
    movff       float32_math_operand_byte2_b0_phys, float32_secondary_work_byte2_b0_phys
    movlw       0x18
...
float32_add_secondary_to_primary_in_place__pack_sum_result:
    movff       float32_aux_work_byte0_b0_phys, addr_low_counter_or_payload_scratch_phys
    movff       float32_math_operand_byte0_b0_phys, addr_high_table_row_or_checksum_scratch_phys
    movff       float32_math_operand_byte1_b0_phys, saved_w_b0_phys
    movff       float32_math_operand_byte2_b0_phys, status_fanout_or_usb_ptr_or_i2c_uart_scratch_phys
    movff       float32_exponent_work_b0_phys, computed_volume_or_flash_count_eeprom_addr_adc_usb_ptr_scratch_phys
    movff       float32_secondary_work_byte3_b0_phys, computed_volume_or_i2c_payload_or_float32_scale_or_adc_eeprom_hi_phys
...
poll_src4382_route_monitor__read_audio_format:
    ...
    movf        src4382_audio_format_latch_b0, W, BANKED
    btfss       STATUS, 2, ACCESS
    bsf         active_flags_acc, 4, ACCESS
    movlw       0x01
    btfss       active_flags_acc, 4, ACCESS
...
float32_multiply_primary_by_secondary_in_place__shift_multiplier_and_product:
    ...
    movff       float32_divide_sign_scratch_phys, addr_low_counter_or_payload_scratch_phys
    movff       float32_accum_work_byte0_b0_phys, addr_high_table_row_or_checksum_scratch_phys
    movff       float32_accum_work_byte1_b0_phys, saved_w_b0_phys
    movff       float32_accum_work_byte2_b0_phys, status_fanout_or_usb_ptr_or_i2c_uart_scratch_phys
    movff       float32_muldiv_result_exponent_b0_phys, computed_volume_or_flash_count_eeprom_addr_adc_usb_ptr_scratch_phys
    movff       float32_aux_work_byte0_b0_phys, computed_volume_or_i2c_payload_or_float32_scale_or_adc_eeprom_hi_phys
...
fw_update_commit_hid_payload_page__copy_staged_payload:
    ...
    clrf        float32_extract_or_divide_counter_acc, ACCESS
    movlw       0x02
    movwf       fw_update_checksum_or_float32_quotient_top_scratch, ACCESS
    bra         flow_main_flash_service_2bb8_2bee
flow_main_flash_service_2bb8_2bea:
    clrf        fw_update_checksum_or_float32_quotient_top_scratch, ACCESS
    clrf        float32_extract_or_divide_counter_acc, ACCESS
flow_main_flash_service_2bb8_2bee:
    movff       hex_byte_save_or_uart_status_block_buffer_phys, float32_muldiv_result_exponent_b0_phys
    movlw       0x04
...
flow_main_flash_service_2bb8_2bf6:
    ...
    addwf       float32_product_or_uart_base_scratch_byte, F, ACCESS
    movlw       0x00
    addwfc      float32_product_or_uart_base_high_scratch_byte, F, ACCESS
    movf        float32_muldiv_result_exponent_acc, W, ACCESS
    subwf       float32_product_or_uart_base_scratch_byte, W, ACCESS
    movwf       FSR2L, ACCESS
    movf        float32_product_or_uart_base_high_scratch_byte, W, ACCESS
    btfss       STATUS, 0, ACCESS
    decf        float32_product_or_uart_base_high_scratch_byte, W, ACCESS
    movwf       FSR2H, ACCESS
    clrf        float32_extract_or_quotient_or_preset_uart_index, ACCESS
    movlw       0x03
    movwf       fw_update_hex_or_float32_quotient_or_uart_block_scratch, ACCESS
    movlb       0x0
    movf        fw_update_page_buffer_offset_b0, W, BANKED
    addwf       float32_extract_or_quotient_or_preset_uart_index, F, ACCESS
    movlw       0x00
    addwfc      fw_update_hex_or_float32_quotient_or_uart_block_scratch, F, ACCESS
    movf        float32_muldiv_product_sign_scratch_acc, W, ACCESS
    addwf       float32_extract_or_quotient_or_preset_uart_index, W, ACCESS
    movwf       FSR1L, ACCESS
    movlw       0x00
    addwfc      fw_update_hex_or_float32_quotient_or_uart_block_scratch, W, ACCESS
    movwf       FSR1H, ACCESS
    movff       INDF2, INDF1
    incf        float32_muldiv_product_sign_scratch_acc, F, ACCESS
    movlw       0x17
    cpfsgt      float32_muldiv_product_sign_scratch_acc, ACCESS
    ...
    movwf       float32_product_or_uart_base_high_scratch_byte, ACCESS
    movff       preset_header_tas_reg_or_uart_block_base_low_scratch_phys, computed_volume_or_flash_count_eeprom_addr_adc_usb_ptr_scratch_phys
    movff       preset_table_header_len_source_phys, computed_volume_or_i2c_payload_or_float32_scale_or_adc_eeprom_hi_phys
    clrf        flash_src_low_or_rx_length_scratch_byte, ACCESS
...
float32_divide_primary_by_secondary_in_place__advance_remainder_next_bit:
    ...
    movff       preset_table_header_len_source_phys, addr_low_counter_or_payload_scratch_phys
    movff       float32_extract_or_quotient_or_preset_uart_index_bank0_phys, addr_high_table_row_or_checksum_scratch_phys
    movff       fw_update_hex_byte_or_uart_block_base_low_scratch_phys, saved_w_b0_phys
    movff       hex_byte_save_or_uart_status_block_buffer_phys, status_fanout_or_usb_ptr_or_i2c_uart_scratch_phys
    movff       float32_muldiv_result_exponent_b0_phys, computed_volume_or_flash_count_eeprom_addr_adc_usb_ptr_scratch_phys
    movff       float32_divide_sign_scratch_phys, computed_volume_or_i2c_payload_or_float32_scale_or_adc_eeprom_hi_phys
...
float32_pack_mantissa_exponent_sign__trim_high_guard_bits:
    ...
    iorwf       eeprom_gate_flash_gie_or_uart_timeout_scratch_byte, W, ACCESS
...
float32_pack_mantissa_exponent_sign__merge_exponent_and_sign_bits:
    ...
    movff       computed_volume_or_flash_count_eeprom_addr_adc_usb_ptr_scratch_phys, eeprom_or_filename_data_or_flash_buffer_ptr_low_or_signature_low_phys
    clrf        eeprom_mask_or_flash_src_high_scratch_byte, ACCESS
    clrf        eeprom_gate_flash_gie_or_uart_timeout_scratch_byte, ACCESS
    clrf        uart_channel_index_or_flash_addr_low_or_float32_rx_scratch, ACCESS
    movff       eeprom_or_filename_data_or_flash_buffer_ptr_low_or_signature_low_phys, timeout_hi_b0_phys
    clrf        eeprom_gate_flash_gie_or_uart_timeout_scratch_byte, ACCESS
    clrf        eeprom_mask_or_flash_src_high_scratch_byte, ACCESS
    clrf        flash_src_low_or_rx_length_scratch_byte, ACCESS
    movf        flash_src_low_or_rx_length_scratch_byte, W, ACCESS
    iorwf       addr_low_counter_or_payload_scratch_byte, F, ACCESS
    movf        eeprom_mask_or_flash_src_high_scratch_byte, W, ACCESS
    iorwf       addr_high_table_row_or_checksum_scratch_byte, F, ACCESS
    movf        eeprom_gate_flash_gie_or_uart_timeout_scratch_byte, W, ACCESS
    iorwf       length_mask_or_divisor_low_scratch_byte, F, ACCESS
    movf        uart_channel_index_or_flash_addr_low_or_float32_rx_scratch, W, ACCESS
...
float32_pack_mantissa_exponent_sign_and_save:
    rcall       float32_pack_mantissa_exponent_sign
    movff       addr_low_counter_or_payload_scratch_phys, flash_saved_tblptrh_phys
    movff       addr_high_table_row_or_checksum_scratch_phys, flash_addr_high_or_adc_loop_or_bsr_save_scratch_phys
    movff       saved_w_b0_phys, adc_loop_value_or_uart_rx_byte_or_flash_read_tblptrl_save_phys
    movff       status_fanout_or_usb_ptr_or_i2c_uart_scratch_phys, float32_sign_or_uart_digit_or_flash_read_tblptrh_save_phys
    return      0
...
truncate_float32_to_integral_float_in_place__convert_through_int32:
    ...
    call        int32_to_float32_and_save, 0x0
    movff       flash_saved_tblptrh_phys, math_temp_result_buffer_phys
    movff       flash_addr_high_or_adc_loop_or_bsr_save_scratch_phys, math_temp_result_byte1_b0_phys
    movff       adc_loop_value_or_uart_rx_byte_or_flash_read_tblptrl_save_phys, math_temp_result_byte2_b0_phys
    movff       float32_sign_or_uart_digit_or_flash_read_tblptrh_save_phys, math_temp_result_byte3_b0_phys
    movff       math_temp_result_buffer_phys, float32_preset_fw_update_scratch_byte0_b0_phys
    movff       math_temp_result_byte1_b0_phys, preset_payload_index_or_float32_shadow_byte1_b0_phys
    movff       math_temp_result_byte2_b0_phys, preset_table_row_len_phys
    movff       math_temp_result_byte3_b0_phys, float32_transform_shadow_byte3_b0_phys
...
format_uint16_radix_ascii_to_w_pointer:
    movff       WREG, flash_addr_low_or_float32_scale_or_flash_read_tblptru_save_phys
...
format_uint16_radix_ascii_to_w_pointer__count_digits:
    movff       flash_addr_high_or_adc_loop_or_bsr_save_scratch_phys, addr_low_counter_or_payload_scratch_phys
    movff       adc_loop_value_or_uart_rx_byte_or_flash_read_tblptrl_save_phys, addr_high_table_row_or_checksum_scratch_phys
...
preset_table_apply_entry_core:
    ...
    movwf       float_product_flash_addr_or_preset_index_scratch_byte, ACCESS
    movff       float32_operand_or_flash_addr_shadow_mid_or_preset_job_index_phys, addr_low_counter_or_payload_scratch_phys
    movff       flash_addr_shadow_upper_or_preset_job_index_or_init_copy_end_phys, addr_high_table_row_or_checksum_scratch_phys
    clrf        length_mask_or_divisor_low_scratch_byte, ACCESS
    clrf        status_addr_high_or_i2c_payload_scratch_byte, ACCESS
    ...
    clrf        flash_end_high_or_loop_mask_scratch_byte, ACCESS
    call        flash_read_to_scratch_buffer, 0x0
...
main_core_service_38a2:
    movff       tas3108_coeff_transform_work_byte0_b0_phys, tas3108_coeff_work_accum_byte0_b0_phys
    movff       tas3108_coeff_transform_work_byte1_b0_phys, tas3108_coeff_work_accum_byte1_b0_phys
    movff       fw_update_line_checksum_ok_b0_phys, tas3108_coeff_work_accum_byte2_b0_phys
    movff       fw_update_crc_feedback_scratch_b0_phys, tas3108_coeff_work_accum_byte3_b0_phys
    ...
    movff       tas3108_coeff_work_accum_byte0_b0_phys, fw_update_relay_shift_byte_phys
    movff       tas3108_coeff_work_accum_byte1_b0_phys, fw_update_even_addr_pending_byte_b0_phys
    movff       tas3108_coeff_work_accum_byte2_b0_phys, fw_update_reply_copy_index_b0_phys
    movff       tas3108_coeff_work_accum_byte3_b0_phys, fw_update_crc_bit_index_b0_phys
    movff       fw_update_relay_shift_byte_phys, float32_preset_fw_update_scratch_byte0_b0_phys
    movff       fw_update_even_addr_pending_byte_b0_phys, preset_payload_index_or_float32_shadow_byte1_b0_phys
    movff       fw_update_reply_copy_index_b0_phys, preset_table_row_len_phys
    movff       fw_update_crc_bit_index_b0_phys, float32_transform_shadow_byte3_b0_phys
    movlw       0x41
...
i2c_emit_tas3108_coeff_from_staged_float:
    ...
    movlw       0x4B
    movwf       float32_product_or_uart_base_high_scratch_byte, ACCESS
    movff       fw_update_relay_page_index_bank0_phys, fw_update_byte_or_flash_addr_mid_or_float_operand_base_phys
    movff       fw_update_relay_current_byte_phys, eeprom_record_count_or_flash_addr_upper_or_preset_addr_low_phys
    movff       fw_update_offset_or_channel_enable_row_base_scratch_bank0_phys, flash_addr_shadow_low_or_preset_table_addr_hi_phys
    movff       channel_enable_route_shift_mask_phys, float32_operand_or_flash_addr_shadow_mid_or_preset_job_index_phys
    call        float32_multiply_primary_by_secondary_in_place, 0x0
    movff       fw_update_byte_or_flash_addr_mid_or_float_operand_base_phys, tas3108_coeff_transform_work_byte0_b0_phys
    movff       eeprom_record_count_or_flash_addr_upper_or_preset_addr_low_phys, tas3108_coeff_transform_work_byte1_b0_phys
    movff       flash_addr_shadow_low_or_preset_table_addr_hi_phys, fw_update_line_checksum_ok_b0_phys
    movff       float32_operand_or_flash_addr_shadow_mid_or_preset_job_index_phys, fw_update_crc_feedback_scratch_b0_phys
    rcall       main_core_service_38a2
    movff       tas3108_coeff_transform_work_byte0_b0_phys, hid_out_coeff_scratch_byte0_b0_phys
    movff       tas3108_coeff_transform_work_byte1_b0_phys, hid_out_coeff_scratch_byte1_b0_phys
    movff       fw_update_line_checksum_ok_b0_phys, hid_out_coeff_scratch_byte2_b0_phys
    movff       fw_update_crc_feedback_scratch_b0_phys, hid_out_coeff_scratch_byte3_b0_phys
    movff       hid_out_coeff_scratch_byte0_b0_phys, float32_math_operand_byte0_b0_phys
    movff       hid_out_coeff_scratch_byte1_b0_phys, float32_math_operand_byte1_b0_phys
    movff       hid_out_coeff_scratch_byte2_b0_phys, float32_math_operand_byte2_b0_phys
    movff       hid_out_coeff_scratch_byte3_b0_phys, float32_math_operand_byte3_b0_phys
    call        float32_to_int32_in_place, 0x0
    movff       float32_math_operand_byte0_b0_phys, tas3108_coeff_tx_byte3_b0_phys
    movff       float32_math_operand_byte1_b0_phys, tas3108_coeff_tx_byte2_b0_phys
    movff       float32_math_operand_byte2_b0_phys, tas3108_coeff_tx_byte1_b0_phys
    movff       float32_math_operand_byte3_b0_phys, tas3108_coeff_tx_byte0_b0_phys
...
flash_erase_without_preset_remap:
    clrf        eeprom_gate_flash_gie_or_uart_timeout_scratch_byte, ACCESS
    movff       addr_low_counter_or_payload_scratch_phys, timeout_hi_b0_phys
    movff       addr_high_table_row_or_checksum_scratch_phys, flash_saved_tblptrh_phys
    movff       saved_w_b0_phys, flash_addr_high_or_adc_loop_or_bsr_save_scratch_phys
    movff       status_fanout_or_usb_ptr_or_i2c_uart_scratch_phys, adc_loop_value_or_uart_rx_byte_or_flash_read_tblptrl_save_phys
...
float32_multiply_ram_window_by_staged_operand_in_place:
    movff       WREG, float32_sign_exponent_offset_scratch_b0_phys
    movf        float32_sign_exponent_offset_scratch_acc, W, ACCESS
    movwf       FSR2L, ACCESS
    clrf        FSR2H, ACCESS
    movff       POSTINC2, fw_update_byte_or_flash_addr_mid_or_float_operand_base_phys
    movff       POSTINC2, eeprom_record_count_or_flash_addr_upper_or_preset_addr_low_phys
    movff       POSTINC2, flash_addr_shadow_low_or_preset_table_addr_hi_phys
    movff       POSTINC2, float32_operand_or_flash_addr_shadow_mid_or_preset_job_index_phys
    ...
    movwf       FSR2L, ACCESS
    clrf        FSR2H, ACCESS
    movff       float32_secondary_work_byte0_b0_phys, POSTINC2
    movff       float32_secondary_work_byte1_b0_phys, POSTINC2
    movff       float32_secondary_work_byte2_b0_phys, POSTINC2
    movff       float32_secondary_work_byte3_b0_phys, POSTDEC2
    decf        FSR2L, F, ACCESS
    decf        FSR2L, F, ACCESS
    return      0
...
float32_add_staged_operand_to_ram_window_in_place:
    movff       WREG, float32_exponent_lo_or_target_offset_scratch_b0_phys
    movf        float32_exponent_lo_or_target_offset_scratch_acc, W, ACCESS
    movwf       FSR2L, ACCESS
    clrf        FSR2H, ACCESS
    movff       POSTINC2, float32_accum_work_byte0_b0_phys
    movff       POSTINC2, float32_accum_work_byte1_b0_phys
    movff       POSTINC2, float32_accum_work_byte2_b0_phys
    movff       POSTINC2, float32_accum_work_byte3_b0_phys
    ...
    movwf       FSR2L, ACCESS
    clrf        FSR2H, ACCESS
    movff       math_temp_result_buffer_phys, POSTINC2
    movff       math_temp_result_byte1_b0_phys, POSTINC2
    movff       math_temp_result_byte2_b0_phys, POSTINC2
    movff       math_temp_result_byte3_b0_phys, POSTDEC2
    decf        FSR2L, F, ACCESS
    decf        FSR2L, F, ACCESS
    return      0
...
usb_ep1_in_copy_scratch_buffer_to_bdt__check_remaining:
    ...
    movlw       0x40
    movlb       0x4
    andwf       usb_ep1_in_bd_status_b4, F, BANKED
    movlw       0x01
    btfsc       usb_ep1_in_bd_status_b4, 6, BANKED
    movlw       0x00
    movwf       status_addr_high_or_i2c_payload_scratch_byte, ACCESS
    swapf       status_addr_high_or_i2c_payload_scratch_byte, F, ACCESS
    rlncf       status_addr_high_or_i2c_payload_scratch_byte, F, ACCESS
    rlncf       status_addr_high_or_i2c_payload_scratch_byte, F, ACCESS
    movf        usb_ep1_in_bd_status_b4, W, BANKED
    xorwf       status_addr_high_or_i2c_payload_scratch_byte, W, ACCESS
    andlw       0xBF
    xorwf       status_addr_high_or_i2c_payload_scratch_byte, W, ACCESS
    movwf       usb_ep1_in_bd_status_b4, BANKED
    bsf         usb_ep1_in_bd_status_b4, 3, BANKED
    bsf         usb_ep1_in_bd_status_b4, 7, BANKED
    return      0
...
flash_read_without_preset_remap:
    movff       addr_low_counter_or_payload_scratch_phys, timeout_lo_b0_phys
    movff       addr_high_table_row_or_checksum_scratch_phys, timeout_hi_b0_phys
    movff       saved_w_b0_phys, flash_saved_tblptrh_phys
    movff       status_fanout_or_usb_ptr_or_i2c_uart_scratch_phys, flash_addr_high_or_adc_loop_or_bsr_save_scratch_phys
    ...
    movff       flash_saved_tblptrh_phys, TBLPTRU
...
usb_ep0_arm_out_pingpong_bd:
    movff       WREG, addr_low_counter_or_payload_scratch_phys
    movlw       0x08
    movlb       0x1
...
usb_ep0_arm_out_pingpong_bd__copy_template_and_set_own:
    ...
    movff       usb_bdt_template_status_phys, POSTINC2
    movff       usb_bdt_template_count_phys, POSTINC2
    movff       usb_bdt_template_addr_lo_phys, POSTINC2
    movff       usb_bdt_template_addr_hi_phys, POSTINC2
    movff       stock_078_b0_phys, FSR2L
    movff       stock_079_b0_phys, FSR2H
    movlb       0x0
    bsf         INDF2, 7, ACCESS
...
format_int16_decimal_ascii_to_w_pointer:
    movff       WREG, float_product_or_output_index_scratch_bank0_phys
...
format_int16_decimal_ascii_to_w_pointer__format_magnitude:
    movff       fw_update_byte_or_flash_addr_mid_or_float_operand_base_phys, eeprom_mask_or_flash_src_high_scratch_phys
    movff       eeprom_record_count_or_flash_addr_upper_or_preset_addr_low_phys, timeout_lo_b0_phys
    movff       flash_addr_shadow_low_or_preset_table_addr_hi_phys, timeout_hi_b0_phys
    movff       float32_operand_or_flash_addr_shadow_mid_or_preset_job_index_phys, flash_saved_tblptrh_phys
    movf        float_product_or_output_index_scratch_byte, W, ACCESS
...
; ---------------------------------------------------------------------------
i2c_secondary_dev_random_read:
    movff       WREG, status_fanout_or_usb_ptr_or_i2c_uart_scratch_phys
...
main_core_service_432e:
    ...
    movff       tas3108_coeff_work_accum_byte0_b0_phys, float32_accum_work_byte0_b0_phys
    movff       tas3108_coeff_work_accum_byte1_b0_phys, float32_accum_work_byte1_b0_phys
    movff       tas3108_coeff_work_accum_byte2_b0_phys, float32_accum_work_byte2_b0_phys
    movff       tas3108_coeff_work_accum_byte3_b0_phys, float32_accum_work_byte3_b0_phys
    movff       tas3108_coeff_result_byte0_b0_phys, float32_aux_work_byte0_b0_phys
    movff       tas3108_coeff_result_byte1_b0_phys, float32_math_operand_byte0_b0_phys
    movff       tas3108_coeff_result_byte2_b0_phys, float32_math_operand_byte1_b0_phys
    movff       tas3108_coeff_result_sign_byte_b0_phys, float32_math_operand_byte2_b0_phys
    call        float32_add_secondary_to_primary_in_place, 0x0
    movff       float32_accum_work_byte0_b0_phys, tas3108_coeff_work_accum_byte0_b0_phys
    movff       float32_accum_work_byte1_b0_phys, tas3108_coeff_work_accum_byte1_b0_phys
    movff       float32_accum_work_byte2_b0_phys, tas3108_coeff_work_accum_byte2_b0_phys
    movff       float32_accum_work_byte3_b0_phys, tas3108_coeff_work_accum_byte3_b0_phys
    return      0
...
uart_emit_formfeed_colon_text_line:
    movff       WREG, fw_update_hex_byte_or_uart_block_base_low_scratch_phys
    movlw       0x0D
    rcall       uart_tx_byte_blocking
    movlw       0x0A
    rcall       uart_tx_byte_blocking
...
preset_replay_selected_table_blocking:
    movlw       0x56
    movwf       fw_update_hex_line_nul_terminator, ACCESS
    clrf        float32_transform_shadow_byte3_acc, ACCESS
    clrf        math_temp_result_byte1_acc, ACCESS
preset_replay_selected_table_blocking__apply_next_entry:
    movff       float32_transform_shadow_byte3_b0_phys, eeprom_record_count_or_flash_addr_upper_or_preset_addr_low_phys
    movff       math_temp_result_buffer_phys, flash_addr_shadow_low_or_preset_table_addr_hi_phys
    call        preset_table_apply_entry_legacy_blocking, 0x0
    movlw       0x18
    addwf       float32_transform_shadow_byte3_acc, F, ACCESS
    movlw       0x00
    addwfc      fw_update_hex_line_nul_terminator, F, ACCESS
    incf        math_temp_result_byte1_acc, F, ACCESS
    movlw       0x5F
    cpfsgt      math_temp_result_byte1_acc, ACCESS
...
i2c_secondary_dev_write:
    movff       WREG, computed_volume_or_flash_count_eeprom_addr_adc_usb_ptr_scratch_phys
    bsf         SSPCON2, 0, ACCESS          ; SEN = START
    rcall       wait_sen_bounded
...
; ---------------------------------------------------------------------------
mssp_hard_reset:
    movff       WREG, addr_high_table_row_or_checksum_scratch_phys
    movlw       0xC0
...
i2c_timeout_recover_common:
    ...
    movlw       0x80
    movwf       addr_low_counter_or_payload_scratch_byte, ACCESS            ; stock SSPSTAT SMP state
...
; ---------------------------------------------------------------------------
; cmd 0x25 — MAIN identity reply (V1.72/V3.3 diagnostics title)
; ---------------------------------------------------------------------------
...
cmd25_identity_query_handler:
    ...
    ; four payloads are low nibbles and can reuse diag_low_nibble_reply_burst.
    movlw       0xBF
    rcall       uart_tx_byte_blocking
    movlw       0x4F
    rcall       uart_tx_byte_blocking
...
cmd26_filename_query_handler:
    ...
    andlw       0x01
    bnz         cmd26_filename_query_handler__suppress_ack_and_return
    movf        filename_rev_b2, W, BANKED
...
filename_reply_job_service__ready_to_emit:
    movf        filename_rev_b2, W, BANKED
    andlw       0x01
    bnz         filename_reply_job_service__abort_stale_reply
    movf        filename_rev_b2, W, BANKED
    cpfseq      fn_job_rev_b2, BANKED
...
; ---------------------------------------------------------------------------
; EEPROM Data (V3.3: version updated at offset 0x82)
; ---------------------------------------------------------------------------
    org 0xF00000
eeprom_data:
