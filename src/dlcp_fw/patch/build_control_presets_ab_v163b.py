...
org 0x1152
    movlw 0x3E                          ; V1.63b version display
...
; V1.63b: hook parser tail (label_063) to add BF/08 handler
org 0x05D0
...
volume_indicator_stub:
    ...
    movlw 0x8F
    call 0x0066
    ; V1.63b: show "!" when DSP fault (0x01F.bit7) is set
...
; --- V1.63b: BF/08 DSP fault handler ---
bf08_check_stub:
    movlw 0x08
...
def main() -> int:
    ...
    ap.add_argument(
        "--out-hex",
        type=pathlib.Path,
        default=PATCHED_CONTROL_HEX_V163B,
