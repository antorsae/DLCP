...
; ============================================================
; Original: call 0x0CFE (function_042)
org 0x13A0
...
; ============================================================
; Original: 0x0E32 -> goto label_164 (0x0E38)
...
new_dispatch_stub:
    ...
    goto check_state_2
    call preset_screen
    goto 0x124A                 ; label_207 (post-screen nav)

check_state_2:
    movlw 0x02
    cpfseq 0xBF, BANKED        ; skip if BF == 2 (Input)
    goto check_state_3
    call 0x19F2                 ; function_052 (Input)
    goto 0x124A                 ; label_207

check_state_3:
    movlw 0x03
    cpfseq 0xBF, BANKED        ; skip if BF == 3 (Setup)
    goto 0x124A                 ; unknown state -> skip
    call 0x1484                 ; function_047 (Setup)
    goto 0x124A                 ; label_207
...
volume_indicator_stub:
    ...
    ; Reuse flags bit7 as "preset sync sent" latch. In V1.5b, bit5 is live stock state.
...
vol_draw:
    ...
    call 0x0CFE                 ; function_042 (original)
    goto 0x13A4                 ; return to post-function_042
...
full_sync_loop_entry:
    movlw 0x06
    cpfslt 0x028, ACCESS
    goto 0x0B82                 ; label_141
    goto 0x0B36                 ; continue original loop body
...
; --- Event loop ---
preset_loop:
    call 0x0CFE                 ; function_042 (wait for event)
...
send_preset_frame_txonly:
    ...
    movwf 0x027, ACCESS
    call 0x05E2                 ; function_020 (serial TX byte)
...
def main() -> int:
    ...
    print(
        ...
        "hooks=[0x10F6,0x1160,0x1196,0x0B2C,0x0E32,0x05C6,0x1256,0x127A,0x148C,0x19FA,0x1230,0x13A0]",
        "stub_range=0x7000+",
    )
    print(
        "version patch:",
