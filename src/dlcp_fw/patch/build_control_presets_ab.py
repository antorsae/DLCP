...
; ============================================================
; Original: label_065 starts with "movlw 0x1D".
...
volume_indicator_stub:
    ...
    ; Reuse flags bit7 as "preset sync sent" latch.
...
def validate_expected(mem: Dict[int, int]) -> None:
    ...
    expected = {
        ...
        0x0E48: 0x07,
        0x0E49: 0xF0,
        # Patch 8: parser-tail hook site (original label_065: movlw 0x1D)
        0x05EC: 0x1D,
        0x05ED: 0x0E,
    }
...
def main() -> int:
    ...
    print(
        ...
        "hooks=[0x1106,0x116E,0x11A4,0x0B52,0x0E46,0x05EC,0x1264,0x1288,0x149A,0x1A08,0x123E,0x13AE]",
        "stub_range=0x7000+",
    )
    print(
        "version patch:",
